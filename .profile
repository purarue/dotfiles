...
export HPIDATA BROWSER XDG_MUSIC_DIR PATH SCREENSHOTS XDG_DOWNLOAD_DIR XDG_DOCUMENTS_DIR XDG_PICTURES_DIR XDG_VIDEOS_DIR SHARED_DIR SYNCTHING_BASE
export PLAINTEXT_PLAYLIST_PLAYLISTS="${SHARED_DIR}/playlists"
